...
<body>
	...
	<br>
	<p>You have been added as an Secondary Admin of {{$schoolName}}. <a href="http://www.asuretots.com">Asure Tots</a>  is happy to have you on on board and as we are one of the best child care app service aiming to provide security and satisfaction to the users.</p>
	...
	<p>You've been given access to {{$schoolName}} admin account on Asure Tots.</p>
